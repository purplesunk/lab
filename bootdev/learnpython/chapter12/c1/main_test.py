...
run_cases = [
    (10.00, 20.00, 10.00),
    (30.00, 20.00, None, "not enough money"),
]

submit_cases = run_cases + [
    (15.10, 15.10, 0.00),
    (1430.00, 69.00, None, "not enough money"),
    (7.50, 7.50, 0.00),
    (100.00, 99.99, None, "not enough money"),
    (0.00, 0.00, 0.00),
]
...
def test(price, money_available, expected_output, expected_err=None):
    ...
    print(f" * money_available: {money_available:.2f}")
    try:
        result = purchase(price, money_available)
